...
let getEnrollmentData=async (req,res)=>{
    let rows;
     await dao.getEnrollmentData(req,res).then((resp)=>{rows=resp;}).catch((err)=>{console.log(err)});
     return rows;
};
...
let getEnrollmentDataById=async (req,res)=>{
    let rows;
     await dao.getEnrollmentDataById(req,res).then((resp)=>{rows=resp;}).catch((err)=>{console.log(err)});
     return rows;
};
