...
async function getAllSalaryInfo(req, res, next) {
  try {
    const salaryInfo = await salaryInfoService.getAllSalaryInfo();
    res.json(salaryInfo);
  } catch (error) {
    next(error);
  }
...
async function getSalaryInfoById(req, res, next) {
  try {
    ...
    const salaryInfo = await salaryInfoService.getSalaryInfoById(salaryId);
      res.json(salaryInfo);
  } catch (error) {
    next(error);
  }
...
async function addSalaryInfo(req, res, next) {
  try {
    ...
    const insertedId = await salaryInfoService.addSalaryInfo(newSalaryInfo);
    res.status(201).json({ message: 'Salary information added successfully', id: insertedId });
  } catch (error) {
    next(error);
  }
}
...
async function updateSalaryInfo(req, res, next) {
  try {
    ...
    await salaryInfoService.updateSalaryInfo(salaryId, updatedSalaryInfo);
...
async function deleteSalaryInfo(req, res) {
  try {
    const salaryId = req.params.salary_id;
    await salaryInfoService.deleteSalaryInfo(salaryId);
