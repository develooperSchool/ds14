...
const RelievingLetter: React.FC = () => {
    ...
    return (
        <>
            ...
            <div className="container">
                <PDFDownloadLink document={generatePDF()} fileName="relieving_letter.pdf">
                ...
                <Modal.Body>
                    <Form>
                        ...
                        <Form.Group controlId="resignationDate">
                            ...
                            <Form.Control type="text" value={resignationDate} onChange={(e) => setResignationDate(e.target.value)} />
                        </Form.Group>
                        <Form.Group controlId="employmentStartDate">
                            <Form.Label>Employment Start Date:</Form.Label>
                            <Form.Control type="text" value={employmentStartDate} onChange={(e) => setEmploymentStartDate(e.target.value)} />
                        </Form.Group>
                        <Form.Group controlId="employmentEndDate">
                            <Form.Label>Employment End Date:</Form.Label>
                            <Form.Control type="text" value={employmentEndDate} onChange={(e) => setEmploymentEndDate(e.target.value)} />
                        </Form.Group>
