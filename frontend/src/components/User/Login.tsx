    ...
    return(
        ...
        <div className="container-fluid mt-5">
            <div className="row"> 
                ...
                <form className="p-3 bg-secondary" onSubmit={(e)=>{submitLoginData(e)}}>
                    <h3 className="text-center">Login Form</h3>
                    <div className="mb-3">
                    <label >Email</label>
                    <input onChange={(e)=>{changeInputEvent(e)}} type="email" name="email" value={login.email} placeholder="Enter Email" className="form-control"/>
                    </div>
                    <div className="mb-1">
                    <label>Password</label>
                    <input type="password" onChange={(e)=>{changeInputEvent(e)}}  name="password" value={login.password}  placeholder="Enter Password" className="form-control"/>
                    </div>
                    <div className="mb-3 ">
