...
const CreateSalaryAnnexure = () => {
  ...
  const submitData = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    dispatch(
      SalaryAnnexureAction.postSalaryAnnexureAction({ body: salaryAnnexure })
    ).then((res: { error: any }) => {
      if (res && !res.error) {
        Navi("/payroll");
      ...
      <div className="row">
        <div className="col">
          ...
          <p>
            ...
            iusto velit adipisci eveniet, accusamus nam a dignissimos obcaecati,
            officiis enim? Consequatur consequuntur reiciendis quaerat
            ...
            <form onSubmit={(e) => submitData(e)} className="mt-2">
              ...
              <div className="mb-2">
                ...
                <input
                  ...
                  onChange={(e) => changeInputEvent(e)}
                  name="designation"
                  value={salaryAnnexure.designation}
                  className="form-control"
                />
              </div>
              <div className="mb-2">
                ...
                <input
                  ...
                  onChange={(e) => changeInputEvent(e)}
                  name="department"
                  value={salaryAnnexure.department}
                  className="form-control"
                />
              </div>
              <div className="mb-2">
                ...
                <input
                  ...
                  onChange={(e) => changeInputEvent(e)}
                  name="job_location"
                  value={salaryAnnexure.job_location}
                  className="form-control"
                />
              </div>
              <div className="mb-2">
              ...
              <div className="mb-2">
                ...
                <input
                  ...
                  value={salaryAnnexure.special_allowance}
                  className="form-control"
                />
              </div>
              <div className="mb-2">
                ...
                <input
                  ...
                  onChange={(e) => changeInputEvent(e)}
                  name="profession_tax"
                  value={salaryAnnexure.profession_tax}
                  className="form-control"
                />
              </div>
              <div className="mb-2">
              ...
              <div className="mb-2">
                ...
                <input
                  ...
                  step="0.01"
                  name="net_salary"
                  value={salaryAnnexure.net_salary}
                  className="form-control"
                  disabled
                />
              </div>
              <div className="mb-2">
                ...
                <input
                  ...
                  onChange={(e) => changeInputEvent(e)}
                  pattern="\d{4}-\d{2}-\d{2}"
                  value={salaryAnnexure.annexure_date}
                  className="form-control"
                />
              </div>
              <div className="mb-2">
