...
const OfferLetter: React.FC = () => {
    ...
    return (
        <>
            ...
            <div className="container">
                <PDFDownloadLink document={generatePDF()} fileName="offer_letter.pdf">
                ...
                <Modal.Body>
                    <Form>
                        ...
                        <Form.Group controlId="joiningDate">
                            ...
                            <Form.Control type="text" value={joiningDate} onChange={(e) => setJoiningDate(e.target.value)} />
                        </Form.Group>
                        ...
                        <Form.Group controlId="reportingTo">
                            ...
                            <Form.Control type="text" value={reportingTo} onChange={(e) => setReportingTo(e.target.value)} />
                        </Form.Group>
                        <Form.Group controlId="basic">
                            <Form.Label>Basic:</Form.Label>
                            <Form.Control type="number" value={basic} onChange={(e) => setBasic(e.target.value)} placeholder="Enter Basic" />
                        </Form.Group>
                        ...
                        <Form.Group controlId="specialAllowance">
                            ...
                            <Form.Control type="number" value={specialAllowance} onChange={(e) => setSpecialAllowance(e.target.value)} placeholder="Enter Special Allowance" />
                        </Form.Group>
                        <Form.Group controlId="professionalTax">
                            <Form.Label>Professional Tax:</Form.Label>
                            <Form.Control type="number" value={professionTax} onChange={(e) => setProfessionTax(e.target.value)} placeholder="Enter Professional Tax" />
                        </Form.Group>
                    </Form>
                </Modal.Body>
                <Modal.Footer>
