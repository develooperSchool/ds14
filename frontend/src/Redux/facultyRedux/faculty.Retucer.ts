...
export let facultySlice = createSlice({
    ...
    extraReducers:(builder)=>{
        builder.addCase(facultyActions.getAllFacultyAction.fulfilled,(state,action)=>{
            state.facultyDetails=action.payload;
        })

        builder.addCase(facultyActions.getFacultyAction.fulfilled,(state,action)=>{
            state.facultyDataByID=action.payload;
        })

        builder.addCase(facultyActions.getSubjectsAction.fulfilled,(state,action)=>{
            state.subjectsDetails=action.payload;
        })

        builder.addCase(facultyActions.getFacultyByIdAction.fulfilled,(state,action)=>{
            state.facultyDataByID=action.payload;
        })
    ...
    //     })
        ...
        builder.addCase(facultyActions.deleteFacultyAction.fulfilled,(state,action)=>{
